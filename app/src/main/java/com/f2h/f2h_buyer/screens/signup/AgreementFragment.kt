...
class AgreementFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.terms.text = "‘Village Veggys’ is a digital platform for selling farm products in India. The use of this platform is limited to persons or companies who are legally allowed to buy or sell farm products in accordance with the rules and regulations of the country.\n" +
                "This platform merely helps sellers to list farm products for sales and buyers to express interest in buying the products, with group administrators maintaining a record of payment transactions between the buyers and sellers. Products and home delivery services offered through the platform are owned by the sellers. ‘Village Veggys’ platform does not vouch for the quality and sustainability of products and delivery services offered by the sellers.\n" +
                ...
                "Registration on the platform is currently free as we are in the testing phase. ‘Village Veggys’ intends to become a paid service in the near future. Fee policy shall be clearly communicated to the users well in advance and their agreement shall be sought as and when the platform becomes a paid service.\n"
